...
class ContaCorrente(Conta):
    # Repetiu a conta abstrata "Conta"
...
# Usa esse if para testar as funções e classes nesse módulo.
# Pois podemos importar esse módulo sem que seja executado esses testes.
