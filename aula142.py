...
# Entendo que devemos usar abstração quando desejamos que o método seja implementado nas subclasses.
# Classes abstratas não podem ser instanciadas até que o metodo abstrato se torne concreto através das subclasses.
